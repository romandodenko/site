...
export function catalog() {
  document.querySelectorAll(".catalog-btn").forEach(function (tabsBtn) {
  ...
  document.querySelectorAll(".catalog-btn").forEach(function (tabsBtn) {
    tabsBtn.addEventListener("click", function (event) {
      ...
      document.querySelectorAll(".catalog-btn").forEach(function (tabContent) {
  ...
  document.querySelectorAll(".catalog-accordion__link").forEach(function (tabsBtn) {
    tabsBtn.addEventListener("click", function (event) {
      ...
      document.querySelectorAll(".catalog-accordion__link").forEach(function (tabContent) {
        tabContent.classList.remove("link-active")
      })
      document.querySelector(`[data-target2="${path2}"]`).classList.add("link-active")
    })
  })
